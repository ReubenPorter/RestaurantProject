<?php
    define("TITLE", "Menu Item | Reuben's Fine Dining");
    include('includes/header.php');

    //security to protect from php attacks
    ...
    if(isset($_GET['item'])) {
        //wrap the item in security function
...
<div id="dish">
    ...
    <p><strong>Suggested beverage: <?php $dish['drink']; ?></strong></p>
